...
for seed in range(seed_begin, seed_end):
    ...
    command = f'mpirun -np 1 --use-hwthread-cpus Rscript aggf5_optimize.r {max_children} sim-output/npy_files_{seed:04d}_{max_children:02d} {seed_results_path} &> {seed_results_path}/log.out'
